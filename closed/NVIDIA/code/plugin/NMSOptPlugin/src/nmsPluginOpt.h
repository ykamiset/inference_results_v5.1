...
public:
    ...
    DetectionOutputOpt(DetectionOutputParameters param, bool confSoftmax, 
                        bool permuteBeforeReshape, bool concatInputs, 
...
protected:
    ...
    std::vector<float> mInScale;
    bool mConfPacked32NCHW;
    bool mSupportsInt8ConfInputs{false};
};

class DetectionOutputOptStatic : public DetectionOutputOpt<IPluginV2IOExt>
{
public:
    DetectionOutputOptStatic(DetectionOutputParameters param, bool confSoftmax, 
                                bool permuteBeforeReshape, bool concatInputs, int numLayers, bool supportsInt8ConfInputs)
        : DetectionOutputOpt(param, confSoftmax, permuteBeforeReshape, concatInputs, numLayers, supportsInt8ConfInputs){};
...
{
public:
    DetectionOutputOptDynamic(DetectionOutputParameters param, bool confSoftmax, bool permuteBeforeReshape, int concatInputs, int numLayers, bool supportsInt8ConfInputs)
        : DetectionOutputOpt(param, confSoftmax, permuteBeforeReshape, concatInputs, numLayers, supportsInt8ConfInputs){};
