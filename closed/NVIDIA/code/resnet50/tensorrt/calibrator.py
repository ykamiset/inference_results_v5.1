...
class RN50Calibrator(trt.IInt8EntropyCalibrator2):
    ...
    def __init__(self, calib_batch_size=1, calib_max_batches=500, force_calibration=False,
        ...
        self.device_input = cudart.cudaMalloc(self.calib_batch_size * IMAGE_C * IMAGE_H * IMAGE_W * 4)
    ...
    def get_batch(self, names):
        ...
        if self.current_idx < self.calib_max_batches:
            ...
            cudart.cudaMemcpy(self.device_input, batch, batch.size * batch.itemsize, cudart.cudaMemcpyKind.cudaMemcpyHostToDevice)
            self.current_idx += 1
