...
class TRTTester(BaseTester):
    def __init__(self,
        ...
        clip_with_proj_precision = 'fp32' if "is_orin" in DETECTED_SYSTEM.extras["tags"] else 'fp16'
        ...
        self.infer_stream = cudart.cudaStreamCreate()  # we run all cuda stream functions on a single stream to simply the tester
    ...
    def _save_buffer_to_images(self, actual_batch_size):
        ...
        cudart.cudaStreamSynchronize(self.infer_stream)  # make sure VAE kernel execution are finished
