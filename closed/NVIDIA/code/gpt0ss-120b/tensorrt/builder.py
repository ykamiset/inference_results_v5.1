...
class GPTOSS_120BQuantizerConfig(QuantizerConfig):
    pp_size: int = 1
    tp_size: int = 1
    ...
    def __init__(self,
                 *args,
                 ...
                 model_path: os.PathLike = paths.MODEL_DIR / "openai/gpt-oss-120b",
                 output_path: os.PathLike = paths.MODEL_DIR / "openai/gpt-oss-120b",
                 dataset_path: os.PathLike = paths.BUILD_DIR / "preprocessed_data/gptoss-120b/v4/perf/",
