...
def cpu_clock_str(cpu_cores: int, cpu_freq: int) -> str:
    ...
    if (cpu_cores) > 0:
        cpu_clock_str += f"""
CPU_A78_0 MIN_FREQ {cpu_clock_min}
CPU_A78_0 MAX_FREQ {cpu_freq}
        """
    if (cpu_cores) > 4:
        cpu_clock_str += f"""
CPU_A78_1 MIN_FREQ {cpu_clock_min}
CPU_A78_1 MAX_FREQ {cpu_freq}
        """
    if (cpu_cores) > 8:
        cpu_clock_str += f"""
CPU_A78_2 MIN_FREQ {cpu_clock_min}
...
DLA0_FALCON MAX_FREQ {dla_falcon_clock}
DLA1_FALCON MAX_FREQ {dla_falcon_clock}
