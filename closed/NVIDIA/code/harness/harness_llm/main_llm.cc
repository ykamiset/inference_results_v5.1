...
int32_t doInference(int argc, char** argv)
{
    ...
    else
    {
        ...
        tensorrt_llm::mpi::MpiComm const& worldCommTRTLLM = tensorrt_llm::mpi::MpiComm::world();
        tensorrt_llm::mpi::MpiComm local_session = worldCommTRTLLM.split(myColor, myRank);
